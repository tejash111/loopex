...
const newProjectIcon = <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
  ...
  <path d="M7.09695 1.86663C6.6178 1.68695 6.08404 1.68719 5.31198 1.68753C4.65293 1.68752 3.99154 1.68755 3.56228 1.72539C3.11997 1.76438 2.73291 1.84684 2.37944 2.04411C1.924 2.29827 1.54821 2.67406 1.29405 3.12949C1.09679 3.48297 1.01432 3.87003 0.97533 4.31233C0.937493 4.7416 0.937493 5.27314 0.9375 5.93218V8.29311C0.937493 10.0244 0.937485 11.3812 1.07981 12.4398C1.22549 13.5233 1.5295 14.3784 2.20061 15.0495C2.87171 15.7206 3.72673 16.0246 4.81028 16.1703C5.86889 16.3126 7.22567 16.3126 8.95695 16.3126H9.96922C10.5813 16.3126 11.1307 16.3126 11.625 16.3038V14.25H10.3125C9.38055 14.25 8.625 13.4945 8.625 12.5625C8.625 11.6305 9.38055 10.875 10.3125 10.875H11.625V9.56248C11.625 8.63053 12.3806 7.87498 13.3125 7.87498C14.2444 7.87498 15 8.63053 15 9.56248V10.875H17.0537C17.0625 10.3807 17.0625 9.83136 17.0625 9.21928C17.0625 8.45503 17.0625 7.77666 17.0123 7.28218C16.9603 6.77176 16.8502 6.3291 16.5885 5.93752C16.3833 5.63042 16.1197 5.36675 15.8126 5.16155C15.421 4.89991 14.9783 4.78977 14.4679 4.73785C13.9734 4.68754 13.3571 4.68755 12.5929 4.68756H9.92708C9.69 4.68756 9.5547 4.68687 9.4548 4.67654C9.3783 4.67119 9.3261 4.61447 9.3096 4.58678C9.25568 4.50208 9.06285 4.11688 8.95687 3.90483C8.6028 3.18847 8.14357 2.2591 7.09695 1.86663Z" fill="#A0A0AB"/>
</svg>

const allProjectsIcon = <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
  <path fillRule="evenodd" clipRule="evenodd" d="M10.3125 11.0624C10.3125 10.6482 10.6483 10.3124 11.0625 10.3124H16.3125C16.7267 10.3124 17.0625 10.6482 17.0625 11.0624C17.0625 11.4766 16.7267 11.8124 16.3125 11.8124H11.0625C10.6483 11.8124 10.3125 11.4766 10.3125 11.0624ZM10.3125 13.3124C10.3125 12.8982 10.6483 12.5624 11.0625 12.5624H16.3125C16.7267 12.5624 17.0625 12.8982 17.0625 13.3124C17.0625 13.7266 16.7267 14.0624 16.3125 14.0624H11.0625C10.6483 14.0624 10.3125 13.7266 10.3125 13.3124ZM10.3125 15.5624C10.3125 15.1482 10.6483 14.8124 11.0625 14.8124H12.9375C13.3517 14.8124 13.6875 15.1482 13.6875 15.5624C13.6875 15.9766 13.3517 16.3124 12.9375 16.3124H11.0625C10.6483 16.3124 10.3125 15.9766 10.3125 15.5624Z" fill="#A0A0AB"/>
  <path d="M7.09695 1.86651C6.6178 1.68683 6.08404 1.68706 5.31198 1.68741C4.65293 1.6874 3.99154 1.68742 3.56228 1.72526C3.11997 1.76425 2.73291 1.84672 2.37944 2.04398C1.924 2.29814 1.54821 2.67394 1.29405 3.12937C1.09679 3.48285 1.01432 3.86991 0.97533 4.31221C0.937493 4.74147 0.937493 5.27301 0.9375 5.93206V8.29294C0.937493 10.0242 0.937485 11.3811 1.07981 12.4397C1.22549 13.5232 1.5295 14.3782 2.20061 15.0493C2.87171 15.7204 3.72673 16.0245 4.81028 16.1701C5.86889 16.3125 7.22567 16.3125 8.95695 16.3125H9.375V11.0624C9.375 10.1304 10.1306 9.37489 11.0625 9.37489H17.0625C17.0625 9.32344 17.0625 9.27154 17.0625 9.21912C17.0625 8.45487 17.0625 7.77657 17.0123 7.28205C16.9603 6.77163 16.8502 6.32898 16.5885 5.9374C16.3833 5.6303 16.1197 5.36662 15.8126 5.16143C15.421 4.89979 14.9783 4.78965 14.4679 4.73773C13.9734 4.68742 13.3571 4.68743 12.5929 4.68744H9.92708C9.69 4.68744 9.5547 4.68674 9.4548 4.67642C9.3783 4.67107 9.3261 4.61435 9.3096 4.58666C9.25568 4.50196 9.06285 4.11675 8.95687 3.9047C8.6028 3.18834 8.14357 2.25898 7.09695 1.86651Z" fill="#A0A0AB"/>
</svg>
...
const generalLinks = [
  ...
  { label: 'Email Automation', href: '#', icon: <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
  ...
  { label: 'Career Page', href: '#', icon: <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
  ...
  { label: 'Messaging', href: '#', icon: <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
...
interface SidebarProps {
  ...
  onSavedSearchSelect?: (id: string | null) => void
}
...
export default function Sidebar({
  ...
  return (
    <aside className={`fixed left-0 top-0 bg-[#1A1A1E] h-screen flex flex-col justify-between transition-all duration-300 z-10 ${showModal || showFilterModal ? 'blur-[2px]' : ''}`} style={{ padding: '12px 16px', width: collapsed ? '56px' : '240px' }}>
      <div>
            ...
            {!collapsed && savedSearches.length > 0 && (
              <div className="mt-3 space-y-1">
                {[...savedSearches].sort((a, b) => new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime()).slice(0, 2).map((search) => {
                  const isSelected = selectedSavedSearchId === search._id
                  return (
                    <button
                      key={search._id}
                      onClick={() => {
                        onSavedSearchClick?.(search.query)
                        onSavedSearchSelect?.(selectedSavedSearchId === search._id ? null : search._id)
                      }}
